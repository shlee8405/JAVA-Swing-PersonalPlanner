...
public class AdminUsersDAO {
	...
	public static AdminUserVO getUserPass(AdminUserVO vo ) {
		AdminUserVO str = getSession().selectOne("memberpassword", vo.getM_id());
		return str;
	}
	
	public static AdminUserVO getUserClass(AdminUserVO vo ) {
		AdminUserVO str = getSession().selectOne("memberclass", vo.getM_id());
