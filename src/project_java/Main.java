...
import project_admin.AdminConnectionDAO;
...
//                    System.out.println("Today is " + date +", \nDAO.clientOpenInstance(today) result is " + ClientDAO.clientOpenInstance(date));
	...
	@Override
	public void run() {
		AdminConnectionDAO.getConnectionCount();
		esc: while (true) {
			try {
...
//						break;
					...
					case 92: // add rows to adminreview model
						...
						for (project_admin.AdminReviewVO p921 : list92) {
							adminMain.adminReview.model
									.addRow(new String[] { p921.getM_id(), p921.getPa_name(), p921.getPr_con(), "삭제" });
						}
						break;
