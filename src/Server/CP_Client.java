...
//						break;
					...
					case 87: // insert user into MEMBER
					  ...
					  case 89: // update user
	                        ...
	                        System.out.println(p89.getUservo().getM_pw());
	                        project_admin.AdminUserVO vo89 = p89.getUservo();
	                        String resultpwd = AdminUsersDAO.getUserPass(vo89).getM_pw();
	                        String result899 = AdminUsersDAO.getUserClass(vo89).getM_class();
